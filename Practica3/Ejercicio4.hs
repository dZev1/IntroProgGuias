...
sumarSoloMultiplos (n1,n2,n3) m | mod (abs n1) m == 0 && mod (abs n2) m == 0 && mod (abs n3) m == 0 = n1 + n2 + n3
                                | mod (abs n1) m == 0 && mod (abs n2) m /= 0 && mod (abs n3) m /= 0 = n1
                                | mod (abs n1) m /= 0 && mod (abs n2) m == 0 && mod (abs n3) m /= 0 = n2
                                | mod (abs n1) m /= 0 && mod (abs n2) m /= 0 && mod (abs n3) m == 0 = n3
                                | mod (abs n1) m == 0 && mod (abs n2) m == 0 && mod (abs n3) m /= 0 = n1 + n2
                                | mod (abs n1) m == 0 && mod (abs n2) m /= 0 && mod (abs n3) m == 0 = n1 + n3
                                | mod (abs n1) m /= 0 && mod (abs n2) m == 0 && mod (abs n3) m == 0 = n2 + n3
                                | otherwise = 0
